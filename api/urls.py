...
from api.views import ClienteViewSet, CajeroViewSet, SucursalViewSet, TipoAtencionViewSet, CajaViewSet, ServicioViewSet, TicketViewSet, TicketServicioViewSet, UserViewSet, LogoutViewSet , LoginViewSet
